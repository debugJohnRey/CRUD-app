    ...
    if (isset($_SESSION['user_id'])) {
        ...
        try {
            ...
            if ($row) {
                ...
                $password = $row['password']; // Note: In a real app, you might not want to display the actual password
...
<header>
  ...
  <div class="profile-container">
    ...
    <div class="profile-info">
      ...
      <p>Password: </p>
      <input type="password" class="profile-info-details" value="<?php echo htmlspecialchars($password); ?>" readonly>
      <p>Date Joined: </p>
      <input type="text" class="profile-info-details" value="<?php echo htmlspecialchars($date_joined); ?>" readonly>
